...
class FeatureContext implements Context
{
    ...
    {
        if (null === $this->exception || $this->exception->getMessage() !== 'Ce véhicule est déjà localisé à cet endroit.') {
    ...
    {
        $command = new ParkVehicleCommand($this->vehicle, $this->location);
        $handler = new ParkVehicleCommandHandler(new VehicleRepository());
        try {
            $handler->handle($command);
